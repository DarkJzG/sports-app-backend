# flask_api/controlador/prompts_pantalon/__init__.py
...
from .sublimacion_geometrico import build_prompt_sublimacion_geometrico, descripcion_sublimacion_geometrico_es
from .sublimacion_artistico import build_prompt_sublimacion_artistico, descripcion_sublimacion_artistico_es


def build_prompt_pantalon_v1(attr: dict) -> str:
    """
    Genera el prompt según el camino seleccionado:
    - solido: Sólido con acentos
    - paneles: Paneles y rayas
    - sublimacion: Diseño sublimado IA (degradado, geométrico, artístico)
    """
    ...
    if camino == "solid":
        ...
        mapping = {
            ...
            "geometric": build_prompt_sublimacion_geometrico,
...
def descripcion_pantalon_es_v1(attr: dict) -> str:
    """
